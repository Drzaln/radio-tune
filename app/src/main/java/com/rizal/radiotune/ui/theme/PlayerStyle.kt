...
data class CassetteLook(
    ...
    // Layout, as fractions of the cassette height/width. The defaults are the
    // shared silhouette every style builds on: a large sticker label with the
    // tape window cut into it.
    val labelTop: Float = 0.10f,
    val labelHeight: Float = 0.60f,
    /** Chamfers the label's top corners when > 0 (fraction of the width). */
    val labelChamfer: Float = 0.05f,
    val windowTop: Float = 0.42f,
    val windowWidth: Float = 0.58f,
    val windowHeight: Float = 0.21f,
    val spoolY: Float = 0.525f,
    val spoolRadius: Float = 0.105f,
    val hubSpokes: Int = 6,
    // Detail switches.
...
private val SemiRealismCassette = CassetteLook(
    ...
    showStripe = false,
    labelBands = listOf(
        LabelBand(Color(0xFFA9C4A0), 0.08f),
        LabelBand(Color(0xFFF1E7C6), 0.44f),
        LabelBand(Color(0xFFE8541E), 0.37f),
        LabelBand(Color(0xFFF6C61C), 0.07f),
        LabelBand(Color(0xFFA9C4A0), 0.04f),
    ),
