...
val releaseVersionName: String = (findProperty("versionName") as String?)?.takeIf { it.isNotBlank() } ?: "1.1.1"
val releaseVersionCode: Int = (findProperty("versionCode") as String?)?.toIntOrNull() ?: 10101
